      ...
      <div className="space-y-5">
        ...
        <FormCard title="III. Exámenes Practicados (ISO 27042)" icon={<Settings size={15} />}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
            ...
            <InputField label="Distro Linux (CAINE/Tsurugi/Santoku/Kali Linux)" value={report.examenes.linuxVersion} onChange={(v) => onReportChange({...report, examenes: {...report.examenes, linuxVersion: v}})} />
          </div>
