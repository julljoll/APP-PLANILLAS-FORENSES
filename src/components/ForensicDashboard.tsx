...
const steps: Step[] = [
  ...
  { id: 3, phase: "Fase 1: Obtención", title: "Adquisición Digital Forense", action: "Extracción física/lógica y sellado hash en entorno Linux forense.", docs: ["Documentación para el Dictamen Pericial"], howTo: "Anotar distro Linux usada (CAINE/Tsurugi/Santoku/Kali Linux), versiones exactas del software y algoritmos Hash.", tutorials: ["Arranca la distro Linux forense (CAINE, Tsurugi, Santoku o Kali Linux).", "Conecta el dispositivo asegurando inalterabilidad (write-blocker).", "Ejecuta Andriller para adquisición no destructiva.", "Calcula Hash SHA-256 de la imagen extraída."] },
  ...
  { id: 6, phase: "Fase 2: Peritaje", title: "Procesamiento con ALEAPP", action: "Parsear logs y bases de datos SQLite sobre entorno Linux.", docs: ["Logs y Tablas de salida de ALEAPP"], howTo: "Garantizar que el reporte liste nombres nativos, fechas, rutas y Hashes. Documentar distro Linux utilizada.", tutorials: ["Carga la imagen forense en ALEAPP (sobre CAINE/Tsurugi/Santoku/Kali Linux).", "Procesa msgstore.db, audios y screenshots.", "Reconstruye el Timeline (ISO 27042).", "Documenta la distro Linux y versiones de herramientas."] },
